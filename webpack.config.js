{
  mode: 'production',
  context: '/Users/natebaker/projects/build-a-bot',
  devtool: 'source-map',
  node: {
    setImmediate: false,
    process: 'mock',
  ...
  output: {
    path: '/Users/natebaker/projects/build-a-bot/dist',
  ...
  resolve: {
    symlinks: false,
    alias: {
      '@': '/Users/natebaker/projects/build-a-bot/src',
    ...
    modules: [
      'node_modules',
      '/Users/natebaker/projects/build-a-bot/node_modules',
      '/Users/natebaker/projects/build-a-bot/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
  ...
  module: {
    ...
    rules: [
      /* config.module.rule('vue') */
      {
        ...
        use: [
          /* config.module.rule('vue').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/natebaker/projects/build-a-bot/node_modules/.cache/vue-loader',
              cacheIdentifier: '39efd89f'
            }
          },
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/Users/natebaker/projects/build-a-bot/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  publicPath: '../'
                }
              },
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          /* config.module.rule('js').use('cache-loader') */
          {
            loader: 'cache-loader',
            options: {
              cacheDirectory: '/Users/natebaker/projects/build-a-bot/node_modules/.cache/babel-loader',
              cacheIdentifier: 'c5988962'
            }
          },
      ...
      /* config.module.rule('eslint') */
      {
        ...
        exclude: [
          /node_modules/,
          '/Users/natebaker/projects/build-a-bot/node_modules/@vue/cli-service/lib'
        ],
        use: [
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/Users/natebaker/projects/build-a-bot/public/index.html'
      }
    ),
    ...
    new CopyWebpackPlugin(
      [
        {
          from: '/Users/natebaker/projects/build-a-bot/public',
          to: '/Users/natebaker/projects/build-a-bot/dist',
          ignore: [
            'index.html',
            '.DS_Store'
          ]
